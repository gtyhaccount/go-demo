...
func main() {
	...
	authKey, err := token.AuthKeyFromFile("./push/ios/mk_cn_intouch_sa_auth_key.p8")
	if err != nil {
		log.Fatal("create auth key Error:", err)
	}
	...
	//notification.Topic = "com.marykay.ap.ent.my.intouch"
